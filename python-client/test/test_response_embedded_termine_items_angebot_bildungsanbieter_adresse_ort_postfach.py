...
class TestResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtPostfach(
    unittest.TestCase
):
    """ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtPostfach unit test stubs"""
    ...
    def testResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtPostfach(self):
        """Test ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtPostfach"""
        # FIXME: construct object with mandatory attributes with example values
        # model = ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtPostfach()  # noqa: E501
        pass
