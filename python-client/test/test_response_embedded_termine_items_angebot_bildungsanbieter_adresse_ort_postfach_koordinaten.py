...
class TestResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtPostfachKoordinaten(
    unittest.TestCase
):
    """ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtPostfachKoordinaten unit test stubs"""
    ...
    def testResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtPostfachKoordinaten(
        self,
    ):
        """Test ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtPostfachKoordinaten"""
        # FIXME: construct object with mandatory attributes with example values
        # model = ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtPostfachKoordinaten()  # noqa: E501
        pass
