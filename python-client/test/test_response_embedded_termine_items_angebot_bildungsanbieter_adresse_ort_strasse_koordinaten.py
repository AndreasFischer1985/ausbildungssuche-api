...
class TestResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasseKoordinaten(
    unittest.TestCase
):
    """ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasseKoordinaten unit test stubs"""
    ...
    def testResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasseKoordinaten(
        self,
    ):
        """Test ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasseKoordinaten"""
        # FIXME: construct object with mandatory attributes with example values
        # model = ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasseKoordinaten()  # noqa: E501
        pass
