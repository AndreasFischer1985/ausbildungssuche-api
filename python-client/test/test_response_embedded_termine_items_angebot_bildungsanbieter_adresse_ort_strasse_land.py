...
class TestResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasseLand(
    unittest.TestCase
):
    """ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasseLand unit test stubs"""
    ...
    def testResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasseLand(
        self,
    ):
        """Test ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasseLand"""
        # FIXME: construct object with mandatory attributes with example values
        # model = ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasseLand()  # noqa: E501
        pass
