...
class TestResponseEmbeddedTermineInnerAngebotBildungsanbieterAdresse(unittest.TestCase):
    """ResponseEmbeddedTermineInnerAngebotBildungsanbieterAdresse unit test stubs"""
    ...
    def testResponseEmbeddedTermineInnerAngebotBildungsanbieterAdresse(self):
        """Test ResponseEmbeddedTermineInnerAngebotBildungsanbieterAdresse"""
        # FIXME: construct object with mandatory attributes with example values
        # model = ResponseEmbeddedTermineInnerAngebotBildungsanbieterAdresse()  # noqa: E501
        pass
