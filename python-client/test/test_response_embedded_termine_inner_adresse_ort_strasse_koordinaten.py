...
class TestResponseEmbeddedTermineInnerAdresseOrtStrasseKoordinaten(unittest.TestCase):
    """ResponseEmbeddedTermineInnerAdresseOrtStrasseKoordinaten unit test stubs"""
    ...
    def testResponseEmbeddedTermineInnerAdresseOrtStrasseKoordinaten(self):
        """Test ResponseEmbeddedTermineInnerAdresseOrtStrasseKoordinaten"""
        # FIXME: construct object with mandatory attributes with example values
        # model = ResponseEmbeddedTermineInnerAdresseOrtStrasseKoordinaten()  # noqa: E501
        pass
