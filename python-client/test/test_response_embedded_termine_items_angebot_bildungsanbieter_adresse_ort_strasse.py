...
class TestResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasse(
    unittest.TestCase
):
    """ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasse unit test stubs"""
    ...
    def testResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasse(self):
        """Test ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasse"""
        # FIXME: construct object with mandatory attributes with example values
        # model = ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasse()  # noqa: E501
        pass
