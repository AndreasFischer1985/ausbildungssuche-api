...
class TestResponseEmbeddedTermineItemsAdresseOrtStrasseKoordinaten(unittest.TestCase):
    """ResponseEmbeddedTermineItemsAdresseOrtStrasseKoordinaten unit test stubs"""
    ...
    def testResponseEmbeddedTermineItemsAdresseOrtStrasseKoordinaten(self):
        """Test ResponseEmbeddedTermineItemsAdresseOrtStrasseKoordinaten"""
        # FIXME: construct object with mandatory attributes with example values
        # model = ResponseEmbeddedTermineItemsAdresseOrtStrasseKoordinaten()  # noqa: E501
        pass
