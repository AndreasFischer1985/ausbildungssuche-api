...
class TestResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresse(unittest.TestCase):
    """ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresse unit test stubs"""
    ...
    def testResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresse(self):
        """Test ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresse"""
        # FIXME: construct object with mandatory attributes with example values
        # model = ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresse()  # noqa: E501
        pass
