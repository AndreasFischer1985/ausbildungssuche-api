...
## Documentation For Models
 ...
 - [ResponseEmbeddedTermineItemsAdresse](docs/ResponseEmbeddedTermineItemsAdresse.md)
 - [ResponseEmbeddedTermineItemsAdresseOrtStrasse](docs/ResponseEmbeddedTermineItemsAdresseOrtStrasse.md)
 - [ResponseEmbeddedTermineItemsAdresseOrtStrasseKoordinaten](docs/ResponseEmbeddedTermineItemsAdresseOrtStrasseKoordinaten.md)
 - [ResponseEmbeddedTermineItemsAngebot](docs/ResponseEmbeddedTermineItemsAngebot.md)
 - [ResponseEmbeddedTermineItemsAngebotBildungsanbieter](docs/ResponseEmbeddedTermineItemsAngebotBildungsanbieter.md)
 - [ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresse](docs/ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresse.md)
 - [ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtPostfach](docs/ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtPostfach.md)
 - [ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtPostfachKoordinaten](docs/ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtPostfachKoordinaten.md)
 - [ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasse](docs/ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasse.md)
 - [ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasseKoordinaten](docs/ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasseKoordinaten.md)
 - [ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasseLand](docs/ResponseEmbeddedTermineItemsAngebotBildungsanbieterAdresseOrtStrasseLand.md)
 - [ResponseEmbeddedTermineItemsAngebotBildungsanbieterLogo](docs/ResponseEmbeddedTermineItemsAngebotBildungsanbieterLogo.md)
 - [ResponseEmbeddedTermineItemsAngebotBildungsart](docs/ResponseEmbeddedTermineItemsAngebotBildungsart.md)
 - [ResponseEmbeddedTermineItemsAngebotSchulart](docs/ResponseEmbeddedTermineItemsAngebotSchulart.md)
 - [ResponseEmbeddedTermineItemsAngebotSuchworteInner](docs/ResponseEmbeddedTermineItemsAngebotSuchworteInner.md)
 - [ResponseEmbeddedTermineItemsAngebotSystematikenInner](docs/ResponseEmbeddedTermineItemsAngebotSystematikenInner.md)
 - [ResponseEmbeddedTermineItemsDauer](docs/ResponseEmbeddedTermineItemsDauer.md)
 - [ResponseEmbeddedTermineItemsUnterrichtsform](docs/ResponseEmbeddedTermineItemsUnterrichtsform.md)
