...
class ResponseEmbeddedTermineInnerAngebotBildungsanbieterLogo(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ResponseEmbeddedTermineInnerAngebotBildungsanbieterLogo - a model defined in OpenAPI
