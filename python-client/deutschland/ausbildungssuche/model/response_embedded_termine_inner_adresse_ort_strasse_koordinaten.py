...
class ResponseEmbeddedTermineInnerAdresseOrtStrasseKoordinaten(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ResponseEmbeddedTermineInnerAdresseOrtStrasseKoordinaten - a model defined in OpenAPI
