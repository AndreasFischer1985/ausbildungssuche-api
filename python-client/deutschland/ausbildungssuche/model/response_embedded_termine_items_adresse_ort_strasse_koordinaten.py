...
class ResponseEmbeddedTermineItemsAdresseOrtStrasseKoordinaten(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ResponseEmbeddedTermineItemsAdresseOrtStrasseKoordinaten - a model defined in OpenAPI
