...
class ResponseEmbeddedTermineItemsAngebotBildungsanbieterLogo(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ResponseEmbeddedTermineItemsAngebotBildungsanbieterLogo - a model defined in OpenAPI
