...
import urllib3
from deutschland.ausbildungssuche.exceptions import ApiValueError
...
class Configuration(object):
    ...
    conf = ausbildungssuche.Configuration(
    ...
    def __init__(
        ...
        """Constructor"""
        self._base_path = (
            "https://rest.arbeitsagentur.de/infosysbub/absuche"
            if host is None
            else host
        )
        """Default Base url
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("ausbildungssuche")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                "url": "https://rest.arbeitsagentur.de/infosysbub/absuche",
